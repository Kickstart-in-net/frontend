...
export default function Home() {
  ...
  return (
    <main className="w-full flex flex-col bg-[#111315] items-center pb-6">
      <Header />
      <div className="w-[100%] h-[60vh] md:h-[130vh]  sky rounded-3xl ">
        ...
        <input
          ...
          className="w-[30%] justify-start text-black border-transparent focus:border-transparent focus:ring-0 focus:outline-none md:text-[20px] bg-white placeholder-[#7F7F7F] font-medium"
        />
        <button
